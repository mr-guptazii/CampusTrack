  ...
  void _openQuickMark(BuildContext context) {
    ...
    showModalBottomSheet(
      ...
      builder: (sheetContext) {
        return _QuickMarkSheet(subjects: subjects);
      },
    );
  }
...
class _QuickMarkSheet extends StatefulWidget {
  ...
  const _QuickMarkSheet({required this.subjects});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AttendanceButtonGroup(
                        selected: _selections[subject.id],
                        onSelect: (status) async {
                          setState(() => _selections[subject.id] = status);
